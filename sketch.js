...
function preload(){
   sunimg = loadImage('/sprites/fire ball.png');
   Mercuryimg = loadImage('/sprites/—Pngtree—mars_360437.png');
   Venusimg = loadImage('/sprites/—Pngtree—c4d realistic simulation planet venus_4463124.png');
   Earthimg = loadImage('/sprites/—Pngtree—beautiful earth elements_3704319.png');
   Marsimg = loadImage('/sprites/—Pngtree—c4d realistic simulation planet mercury_4463126.png');
   Jupiterimg = loadImage('/sprites/—Pngtree—cartoon jupiter elemental illustration_4179122.png');
   Uranusimg = loadImage('/sprites/—Pngtree—beautiful uranus illustration_4556395 (1).png');
   Neptuneimg = loadImage('/sprites/—Pngtree—blue universe planet illustration_4555450.png');
}
function setup() {
  ...
  Mercury.addImage(Mercuryimg, 10, 10, .1, .1);
  Mercury.scale = 0.01;
  Mercury.mirrorX(-1);
  ...
  Venus.addImage(Venusimg, 10, 10, .1, .1);
  Venus.scale = 0.01;
  Venus.mirrorX(-1);
  ...
  Earth.addImage(Earthimg, 10, 10, .1, .1);
  Earth.scale = 0.01;
  Earth.mirrorX(-1);
  ...
  Mars.addImage(Marsimg, 10, 10, .1, .1);
  Mars.scale = 0.01;
  Mars.mirrorX(-1);
  ...
  Jupiter.addImage(Jupiterimg, 10, 10, .1, .1);
  Jupiter.scale = 0.01;
  Jupiter.mirrorX(-1);
  ...
  Uranus.addImage(Uranusimg, 10, 10, .1, .1);
  Uranus.scale = 0.01;
  Uranus.mirrorX(-1);
  ...
  Neptune.addImage(Neptuneimg, 10, 10, .1, .1);
  Neptune.scale = 0.01;
  Neptune.mirrorX(-1);
...
function draw() {
  ...
  sun = createSprite(350, 350, 10, 10);
  sun.addImage(sunimg, 10, 10, .1, .1);
  sun.scale = size;
